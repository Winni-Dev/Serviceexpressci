...
//   return (
//     <div>
//       <section className="relative bg-gradient-to-br from-[#0A2240] via-[#0d2d52] to-[#0A2240] text-white py-20 overflow-hidden">
...
//                 Services à domicile{' '}
//                 <span className="text-[#FF6600]">rapides et fiables</span>
//               </h1>
//               <p className="text-lg text-white/70 mb-8 max-w-lg">
//                 Trouvez un artisan qualifié près de chez vous en Côte d'Ivoire
//               </p>
//               <div className="flex flex-wrap gap-4">
//                 <Button size="lg" className="rounded-xl bg-[#FF6600] hover:bg-[#e55a00]" onClick={() => openRequest()}>
//                   Faire une demande
//                 </Button>
//                 <Button
//                   size="lg"
//                   variant="outline"
//                   className="rounded-xl bg-transparent text-white border-white/30 hover:bg-white/10"
//                   asChild
//                 >
...
//             >
//               <img src={IMGACC} alt="Service Express CI" className="w-full drop-shadow-2xl" />
//             </motion.div>
//           </div>
//         </div>
//       </section>
...
//             <h2 className="text-3xl font-bold text-[#0A2240] mb-3">Nos services</h2>
...
//         <div className="container mx-auto px-4">
//           <h2 className="text-3xl font-bold text-center text-[#0A2240] mb-12">Pourquoi nous choisir ?</h2>
...
//                 className="text-center rounded-2xl border border-gray-100 bg-[#f8f9fb] p-8 hover:shadow-md transition-shadow"
//               >
//                 <div className="w-14 h-14 bg-[#FF6600]/10 rounded-2xl flex items-center justify-center mx-auto mb-4">
//                   <feature.icon className="w-7 h-7 text-[#FF6600]" />
//                 </div>
//                 <h3 className="font-semibold text-lg text-[#0A2240] mb-2">{feature.title}</h3>
...
//       <section className="bg-gradient-to-r from-[#FF6600] to-[#e55a00] text-white py-16">
//         <div className="container mx-auto px-4 text-center">
//           <h2 className="text-3xl font-bold mb-3">Besoin d'un service urgent ?</h2>
//           <p className="text-white/80 mb-8 max-w-lg mx-auto">
//             Contactez-nous maintenant et obtenez une intervention rapide
//           </p>
//           <Button
//             size="lg"
//             className="rounded-xl bg-white text-[#FF6600] hover:bg-gray-100 shadow-lg"
//             asChild
//           >
